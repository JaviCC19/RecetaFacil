...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class Coil3LibraryAccessors extends SubDependencyFactory {
        private final Coil3CoilLibraryAccessors laccForCoil3CoilLibraryAccessors = new Coil3CoilLibraryAccessors(owner);

        public Coil3LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>coil3.coil</b>
         */
        public Coil3CoilLibraryAccessors getCoil() {
            return laccForCoil3CoilLibraryAccessors;
        }

    }

    public static class Coil3CoilLibraryAccessors extends SubDependencyFactory {

        public Coil3CoilLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("coil3.coil.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coilComposeVersion</b> with value <b>3.0.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
